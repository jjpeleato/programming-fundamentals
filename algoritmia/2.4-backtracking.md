...
Para determinar que nodo va a ser expandido, dependiendo de la estrategia de ramificación, necesitamos una estructura capaz de almacenar aquellos nodos pendientes de ser analizados **\(Lista de Nodos Vivos, LNV\)**.
...
Los pasos a seguir para una estrategia de ramificación son los siguientes:

* Obtener un elemento N de la lista de nodos vivos.
* Generar todos los descendientes de N.
* Si no se podan y no son solución, se añaden a la LNV.
...
### 2.4.8 Caso práctico: El problema de las 8-Reinas
