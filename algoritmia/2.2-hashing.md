...
Si la posición de un elemento ya esta ocupada entonces hay que insertarlo en otra nueva mediante el proceso de **solución de colisiones**, además en el proceso de búsqueda, hay que tener en cuenta esta situación.
