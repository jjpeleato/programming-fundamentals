...
{% hint style="danger" %}
Cómo podemos ver, para el segundo caso de H\(O\), dado que hemos elegido la exploración cuadrática, no se podría realizar la inserción. Aun quedándose 9 espacios libres. Se podría decir que no es una función Hashing eficiente.
{% endhint %}
