...
* Si las concentraciones de claves son muy frecuentes, la búsqueda será principalmente secuencial perdiendo así las ventajas de la técnica Hash.
  * 90% ocupación → 50 intentos de media para insertar.
  * 75% ocupación → 8,5 intentos de media para insertar.
  * 50% ocupación → 2,5 intentos de media para insertar.
