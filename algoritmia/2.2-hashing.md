...
A partir de un nombre y apellido, por cada letra, conseguir el número binario y éste, pasarlo a decimal y realizar el módulo de 26 e insertarlo en una tabla Hash de 20 posiciones. Si existe colisión, resolverlo mediante exploración cuadrática.
...
Nombre y apellido: José Peleato.

| Letra | Binario | Decimal | Módulo 26 |
| :--- | :--- | :--- | :--- |
| J | 01001010 | 74 | 22 |
| O | 01001111 | 79 | 1 |
| S | 01010011 | 83 | 5 |
...
| Número de intentos para encontrar un dato | \(1 / 0,55\) \* ln\(1 / \(1 - 0,55\)\) = 1,4518 = 2 |
