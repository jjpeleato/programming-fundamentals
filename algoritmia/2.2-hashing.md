...
La probabilidad de que un nuevo registro colisione en el primer intento es igual al factor de carga \(suponiendo que todos los huecos tienen la misma probabilidad de ser accedidos\).
