...
Tras leer la definición de la WikiPedia, podríamos decir que en informática, una tabla Hash \(o Hashing\)

{% hint style="info" %}
El termino **Hashing** también puede ser llamada: **Tabla hash, mapa hash, matriz asociativa, tabla de dispersión o tabla fragmentada**.
{% endhint %}
