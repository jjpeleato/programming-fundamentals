...
* **Dependencia de valores de la entrada:** Aunque fijemos el tamaño del ventor, no se tarda lo mismo en buscar un valor que está en la primera posición que otro que no esté en el vector.
...
* Uno o más valores relacionadas con los datos de entrada que sirven de parámetros para expresar las funciones que miden el uso de recursos del algoritmo.
...
* La complejidad temporal se denominará mediante la función E\(n\)
...
3. Problema del salto de caballo.
4. Problema de los cuadrados mágicos.
